...
lpg:CreateSlider("Health", function(h) game.Players.LocalPlayer.Character.Humanoid.Health = h end,0,200,nil,true,game.Players.LocalPlayer.Character.Humanoid.Health)
