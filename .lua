...
lpg:CreateSlider("Jump Power", function(jp) game.Players.LocalPlayer.Character.Humanoid.JumpPower = jp end,0,2000,nil,true,game.Players.LocalPlayer.Character.Humanoid.JumpPower)
