...
lpg:CreateSlider("Health", function(h) game.Players.LocalPlayer.Character.Humanoid.Health = h end,0,1000,nil,true,game.Players.LocalPlayer.Character.Humanoid.Health)
